...
//   const locations = [
//     {
//       city: "Jaipur -LandMark Properties",
//       address:
//         "DAMAC Towers Riyadh South Tower Olaya Building #90-B20 Zone40 Ali bin Talib District King Fahd Road, Riyadh, Saudi Arabia",
//       phone: "CALL NOW",
//     },
//     {
...
//     },
//     {
//       city: "Kota - LandMark Properties",
//       address:
//         "Land Mark Properties Lebanon SAL Unit 1801, 18th Floor DAMAC Tower Omar Daouk Street Mina El Hosn, Beirut Central District",
//       phone: "CALL NOW",
//     },
//   ];
...
//   return (
//     <footer className="bg-black text-white w-full relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen  py-10 px-4 md:px-32">
...
//         {/* Social Media Section with yellow accent */}
//         <div className="border-t border-gray-800 pt-8">
//           <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
//             {/* Our Agencies */}
//             <div>
//               <h3 className="text-sm font-semibold mb-3 text-gray-300 relative inline-block">
//                 Our Agencies
...
//                   <span
//                     key={index}
//                     className="text-xs text-gray-400 hover:text-yellow-400 transition-colors cursor-default"
//                   >
//                     {agency}
